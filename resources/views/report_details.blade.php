...
<div class="row">
 ...
 <div class="col-md-2 titelsize"> মোট টাকা :</div>  
 <div class="col-md-2 titelsize">{{$data->amount}}</div>
 <div class="col-md-3 titelsize"> টাকা জামাদানের রশিদ নাম্বার :</div>
 <div class="col-md-2 titelsize">{{$data->tland}}</div>
 <div class="col-md-1 titelsize">তারিখ : </div>
 <div class="col-md-2 titelsize">{{$data->cdate}}</div>

</div>
<br>
<div class="row">
    <div class="col-sm-12">
<h5>মানি রিসিটের ছবি</h5></br>
   </div>
</div>

<div class="row">
 <div class="col-md-6"><img src="../public/upload/{{$data->image}}" class="imag"></div></div>
...
<div class="row">
  <div class="col-md-2 titelsize">রিপোর্টার নাম :</div>
  <div class="col-md-3 titelsize">{{$recive->name}} </div>
  <div class="col-md-1 titelsize">পদবি : </div>
  <div class="col-md-2 titelsize">{{$recive->utype}} </div>
  <div class="col-md-1 titelsize">তারিখ: </div>
  <div class="col-md-2 titelsize"> {{$recive->idate}} </div>
</div>

<div class="row">
  <div class="col-md-3 titelsize">বিস্তারিত:</div>
</div>
<br>
<div class="row">
  <div class="col-md-12 titelsize">{{$recive->details}}</div>
</div>
