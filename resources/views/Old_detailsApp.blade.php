...
<!-- <div class="col-md-2 titelsize">খারিজ :</div>
 <div class="col-md-2 titelsize"></div>-->
  ...
  <div class="col-md-1 titelsize">{{$adata->classification}}</div>
...
<div col-md-6> <h4>মন্তব্য বিস্তারিত :</h4> </div>
<div col-md-6> </div>
...
<tr> 
  <td>রিপোর্টার নাম : {{$comments->name}} </td>
  <td>পদবি : {{$comments->utype}} </td>
  <td>তারিখ: {{$comments->adate}}</td>
  <td>সময় : {{$comments->atime}}</td>
</tr>  

<tr>
  <td colspan="4"> {{$comments->acomment}}  </td>
  </tr> 
@endforeach
</table>  
<br>
...
<div class="row" style="margin-left:7px;">
<div col-md-6> <h4> প্রতিবেদন : </h4> </div>
<div col-md-6> </div>
</div>
...
<div class="row" style="margin-left:7px;">
<div col-md-6> <h4> টাকা পরিশোধ : </h4> </div>
</div>
...
@foreach($cash as $cash)
	<tr> 
		<td>মোট প্লিন্থ এরিয়া :</td>
		<td>{{$cash->tland}} বঃ ফুট</td>
		<td>মোট ফি : </td>
		<td>{{$cash->amount}} টাকা</td>
	</tr>
...
<tr> 
<td colspan="4">
  <img src="../public/upload/{{$cash->image}}" class="imag">
</td>
@endforeach
...
<!--<div class="col-md-6">  &nbsp; <a class="btn btn-primary" href="../pdfdetails/{{$adata->id}}">Export to PDF</a>   </div>-->

@if(Auth::user()->utype!='Mayor')

<div class="col-md-6"> 

<form  action="{{URL::to('/oldadminsubmit')}}"  method="post" enctype="multipart/form-data">
{{ csrf_field() }} 
...
@enderror
<textarea class="form-control" name="admindetails"> </textarea> 
<br>
 <div class="row">
  ...
  <select id="inlineFormCustomSelect" name="sendername" required>     
    <option selected="selected">--প্রেরণকারী নাম নির্বাচন করুন--</option>
  ...
  <input type="hidden" class="form-control" name="apman" value="{{$adata->amid}}">
  <input type="hidden" class="form-control" name="appid" value="{{$adata->appid}}">
  <input type="hidden" class="form-control" name="apstatus" value="send">
...
<form action="{{URL::to('/mayorsub')}}"  method="post" enctype="multipart/form-data">
 ...
 <div class="row">
  ...
  <input type="hidden" class="form-control" name="mobile" value="{{$adata->mobilenumber}}">
  <button type="submit" class="btn btn-primary"> দাখিল করুন  </button>
...
<!-- <div class="row" style="margin-top:40px;">
 <div class="col-md-2 text-center"> <img src="../public/image/mamun_akther.jpg"> </div>
 <div class="col-md-2 text-center"> <img src="../public/image/ashrafuzzaman.jpg">  </div>
 <div class="col-md-2 text-center"> <img src="../public/image/anisur-rahman.jpg"> </div>
 <div class="col-md-2 text-center"> <img src="../public/image/robiul_kobir.jpg"> </div>
 <div class="col-md-2 text-center"> <img src="../public/image/abdul_salam_mia.jpg"> </div>
